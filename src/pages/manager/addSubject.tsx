...
const AddSubjectPage: React.FC = () => {
  ...
  return (
    <div className="p-6 mx-auto max-w-6xl">
      ...
      >
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Add New Subject</h1>
          <p className="text-gray-600">Create new subjects for the curriculum</p>
        </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-blue-100">Ready to Create</div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600 font-medium">
                    All data is ready for creation
                  </span>
                </div>
